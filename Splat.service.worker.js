...
const CACHE_NAME = "Splat-cache";
const OFFLINE_URL = "Splat.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Splat.html","Splat.js","Splat.wasm","Splat.pck","Splat.offline.html","Splat.icon.png","Splat.apple-touch-icon.png"];
